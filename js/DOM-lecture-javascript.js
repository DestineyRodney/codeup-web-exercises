var topHeader = document.getElementById
    ("top-header");
...
var hopHeader = document.getElementById
    ("hop-teader");
console.log(hopHeader);
...
for (var i = 0; i < topSellers.length; i++){
    console.log(topSellers[i].innerHTML = "<strong>HatTBD></strong>");
}
