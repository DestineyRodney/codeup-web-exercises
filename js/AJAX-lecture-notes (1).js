...
//ajax updates without refreshing the page ex: Google Maps
// // .ajax(url) - without any OPTIONS, defaults to a GET request:
// $.ajax("https://hookb.in/LgJdODkx33h18Vqq8Vdj").done(function(data){
//     console.log(data);
// })
...
$.ajax("https://hookb.in/LgJdODkx33h18Vqq8Vdj",
    {
        type: "POST",
        data: {
            cohort: "Quasar",
